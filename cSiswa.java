 ...
 * @author AriesUX
 */
public class cSiswa extends javax.swing.JInternalFrame {
    ...
    public void bacaTable(){
       ...
       {
           s=c.createStatement();
           String sql = "SELECT nis, nama, kelas FROM siswa";
           ...
           while(r.next())
           {
               ...
               datasiswa[x][2]=r.getString("kelas");
               x++;
           }
    ...
    public void Pencarian(){
        try 
       {
           s=c.createStatement();
           String sql = "SELECT nis, nama, kelas FROM siswa "
                   + "WHERE nis LIKE '%"+jtNis.getText()+"%' or nama LIKE '%"+jtNis.getText()+"%'";
           r=s.executeQuery(sql);
           ResultSetMetaData m=r.getMetaData();
           int kolom=m.getColumnCount();
           int baris=0;
